...
export const deletePost = async (postId, setCurrentUser) => {
    ...
    try {
      ...
      const updatedPosts = currentUser.posts.filter((post) => post._id !== postId);
  ...
  export const addPost = async (currentUser, setCurrentUser, setPostText, setPhotoVideoContent, postText, photoVideoContent) => {
    try {
